            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Edit Klase</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="col-md-8">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Info Klase</h3>
                  </div>
                  <!-- /.card-header -->
                    ...
                    <form name="addlawyer" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="exampleInputFullname">Profesora</label>
                        ...
                        <!--Class Pic---->
                        <div class="form-group">
                          <label for="exampleInputFile">Imajen Perfil </label>
                          <img src="classpic/<?php echo $result['feacturePic'] ?>" width="120">
                          <a href="update-class-pic.php?cid=<?php echo $result['classid']; ?>">Update Imajen Klase</a>
                        </div>
