...
?>
  ...
  <head>
    ...
    <title>Vizitante sira nebe la hetan vizita</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Vizitante sira nebe la hetan vizita</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  <li class="breadcrumb-item active">Vizitante sira nebe la hetan vizita</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
                ...
                <div class="card">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Detalu La Vizitante</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
